  ...
  return (
    <div>
      <div className="bg-[url('/src/assets/bg_whoarewe.jpg')] h-[100%] bg-center bg-cover">
        <div className="text-white h-[80%] pt-[200px] px-[25px] mx-[25px] flex flex-col items-center text-center">
          ...
          <div className="pt-12 grid md:grid-cols-2 grid-cols-center gap-10">
            <Button name={"What do we do?"} buttonType={BUTTON_TYPE_CLASSES.base} />
            <Button name={"Projects"} buttonType={BUTTON_TYPE_CLASSES.inverted} />
          </div>
